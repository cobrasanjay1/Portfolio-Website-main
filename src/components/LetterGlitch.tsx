...
const LetterGlitch: FC<LetterGlitchProps> = ({
  ...
  const updateLetters = () => {
    ...
    for (let i = 0; i < updateCount; i++) {
      ...
      letters.current[index].startColor = letters.current[index].targetColor || letters.current[index].color;
      letters.current[index].targetColor = target;

      if (!smooth) {
        letters.current[index].color = target;
